...
def test_preprocess_data():
    ...
    assert 'B_b' in processed_data and processed_data['B_b'].dtype == 'int', "Categorical variables were not encoded correctly"
    assert 'B_c' in processed_data and processed_data['B_c'].dtype == 'int', "Categorical variables were not encoded correctly"
